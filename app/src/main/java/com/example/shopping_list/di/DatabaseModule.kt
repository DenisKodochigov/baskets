            ...
            .addCallback( object: RoomDatabase.Callback(){
                override fun onCreate(db: SupportSQLiteDatabase) {
                    ...
                    ioThread {
                        ...
                        database.dataDao().addSection(SectionEntity(nameSection = "Продукты"))
                        ...
                        database.dataDao().addArticle(ArticleEntity(nameArticle = "Молоко", sectionId = 1, unitId = 4))
                        database.dataDao().addArticle(ArticleEntity(nameArticle = "Масло", sectionId = 1, unitId = 3))
                        database.dataDao().addArticle(ArticleEntity(nameArticle = "Клей", sectionId = 1, unitId = 1))
                        database.dataDao().addArticle(ArticleEntity(nameArticle = "Картошка", sectionId = 1, unitId = 2))
                        database.dataDao().addArticle(ArticleEntity(nameArticle = "s", sectionId = 1, unitId = 2))
                        database.dataDao().addArticle(ArticleEntity(nameArticle = "d", sectionId = 1, unitId = 2))
                        database.dataDao().addArticle(ArticleEntity(nameArticle = "f", sectionId = 1, unitId = 2))
                        database.dataDao().addArticle(ArticleEntity(nameArticle = "g", sectionId = 1, unitId = 2))
                        database.dataDao().addArticle(ArticleEntity(nameArticle = "h", sectionId = 1, unitId = 2))
                        database.dataDao().addArticle(ArticleEntity(nameArticle = "j", sectionId = 1, unitId = 2))
                        database.dataDao().addArticle(ArticleEntity(nameArticle = "k", sectionId = 1, unitId = 2))
                        database.dataDao().addArticle(ArticleEntity(nameArticle = "l", sectionId = 1, unitId = 2))
                        database.dataDao().addArticle(ArticleEntity(nameArticle = "z", sectionId = 1, unitId = 2))
                        database.dataDao().addArticle(ArticleEntity(nameArticle = "x", sectionId = 1, unitId = 2))
                        database.dataDao().addArticle(ArticleEntity(nameArticle = "c", sectionId = 1, unitId = 2))
