            ...
            .addCallback( object: RoomDatabase.Callback(){
                override fun onCreate(db: SupportSQLiteDatabase) {
                    ...
                    ioThread {
                        ...
                        database.dataDao().addSection(SectionEntity(nameSection = "Молочные"))
                        database.dataDao().addSection(SectionEntity(nameSection = "Химия"))
                        ...
                        database.dataDao().addArticle(ArticleEntity(nameArticle = "Молоко-2", sectionId = 2, unitId = 4))
