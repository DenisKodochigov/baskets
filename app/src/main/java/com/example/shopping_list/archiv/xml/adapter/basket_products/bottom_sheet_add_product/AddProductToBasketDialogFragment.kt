...
//import com.example.shopping_list.animation.BottomSheetSharedTransition
...
//
//@AndroidEntryPoint
//class AddProductToBasketDialogFragment @Inject constructor(): BottomSheetDialogFragment() {
//
...
//
//        childFragmentManager.beginTransaction().add(R.id.container,
...
//    }
//
//    fun goToNewProductFragment() = transitToFragment(NewProductFragment.newInstance())
//
...
//}
//
//fun Fragment.gotoFragment(action: AddProductToBasketDialogFragment.() -> Unit) {
//    parentFragment?.let { it as? AddProductToBasketDialogFragment }?.also(action)
//}